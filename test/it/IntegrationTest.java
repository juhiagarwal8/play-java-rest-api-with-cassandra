...
public class IntegrationTest extends WithApplication {
	...
	@Test
	public void testListWithTrailingSlashIsUnknown() throws Exception {
		UserRepository repository = app.injector().instanceOf(UserRepository.class);
	...
	@Test
	public void testTimeoutOnUpdate() throws Exception {
		UserRepository repository = app.injector().instanceOf(UserRepository.class);
	...
	@Test
	public void testCircuitBreakerOnShow() throws Exception {
		UserRepository repository = app.injector().instanceOf(UserRepository.class);
